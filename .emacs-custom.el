(custom-set-variables
 ...
 '(org-beamer-environments-extra (quote (("onlyenv" "O" "\\begin{onlyenv}%a" "\\end{onlyenv}"))))
 ...
 '(proof-shell-clear-goals-regexp "No\\s-+more\\s-+subgoals\\.\\|Subtree\\s-proved!\\|Proof\\s-completed")
...
(dependent evars:")
 '(proof-shell-error-regexp "^\\(Error:\\|Discarding pattern\\|Syntax error:\\|System Error:\\|User Error:\\|User error:\\|Anomaly[:.]\\|Toplevel input[,]\\)")
 ...
 '(proof-shell-proof-completed-regexp "No\\s-+more\\s-+subgoals\\.\\|Subtree\\s-proved!\\|Proof\\s-completed")
