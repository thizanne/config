...
beautiful.init("/home/thibault/.config/awesome/themes/suze/theme.lua")
...
vicious.register(datewidget, vicious.widgets.date, "[%H:%M - %d %b %Y]", 60)

-- Create a CPU widget
-- cpuwidget = widget({ type = "textbox" })
-- vicious.register(cpuwidget, vicious.widgets.cpu, "[CPU $1% : $2% - $3%]", 10)

-- Create a RAM widget
-- memwidget = widget({ type = "textbox" })
-- vicious.register(memwidget, vicious.widgets.mem, "[RAM $1%]", 10)

-- Create a battery widget
batwidget = widget({ type = "textbox" })
vicious.register(batwidget, vicious.widgets.bat, "[BAT $2% $1]", 2, "BAT0")
...
globalkeys = awful.util.table.join(
				   ...
				   awful.key({ modkey }, "x",
						...
						awful.prompt.run({ prompt = "Run Lua code: " },
								 ...
								 awful.util.eval, nil,
								 awful.util.getdir("cache") ..
								    "/history_eval")
					     end),
				   -- Custom
				   awful.key({ modkey }, "<", 
					     function ()
						teardrop("urxvtc", "bottom", "center", 1, .35)
					     end),
				   awful.key({ modkey, "Shift" }, "<",
					     function()
						teardrop("urxvtc -e ncmpcpp", 
							 "center", "center", .5, .5)
					     end),
				   awful.key({ modkey, "Shift" }, "w",
					     function()
						teardrop("urxvtc -e wicd-curses", 
							 "center", "center", .5, .5)
					     end)
				)
